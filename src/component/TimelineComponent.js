...
const TimelineComponent = () => {
    const steps = [
        { title: 'Bac STI2D  - Specialized in Technological Innovation and Sustainable Development Option Numeric System ', date: '2017/2019', description: 'Lycée Pierre Rouge', position: "stepLabelBottom", positionTop: false, topLabel: '', topDate: '', topDescription: '', heightPercentage: 0},
